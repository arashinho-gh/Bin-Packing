...
CANADIATES: list[Online | Offline] = [NextFit_Online(), FirstFit_Online(), BestFit_Online(
), WorstFit_Online(), NextFit_Offline(), FirstFit_Offline(), BestFit_Offline(), WorstFit_Offline()]
