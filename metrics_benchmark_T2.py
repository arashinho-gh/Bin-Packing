...
CANADIATES = [NextFit_on(), FirstFit_on(), BestFit_on(), WorstFit_on(), NextFit_of(), FirstFit_of(), BestFit_of(), WorstFit_of()]
METRICS = ['num_of_bins_created', 'num_of_times_checked_bins', 'num_of_compares']
