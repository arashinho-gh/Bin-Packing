...
def main(file,format,CASES):
    algos = [NextFit_on(), FirstFit_on(), BestFit_on(), WorstFit_on(), NextFit_of(), FirstFit_of(), BestFit_of(), WorstFit_of(), baseline_of()]
...
def run_bench(cases: list[str],algos,optimal_solutions):
    ...
    for i in dataset:
        ...
        colors = ["red","green","blue","yellow","pink","black","orange","purple","gray"]
